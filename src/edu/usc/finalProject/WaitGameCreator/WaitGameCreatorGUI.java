...
public class WaitGameCreatorGUI extends JPanel {
	...
	public static void main(String[] args) {
		...
		uFrame.setSize(WaitGameCreatorGUI.WINDOW_X, WaitGameCreatorGUI.WINDOW_Y);
		...
		WaitGameCreatorGUI uWaitGame = new WaitGameCreatorGUI();

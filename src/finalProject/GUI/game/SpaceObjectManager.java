...
public class SpaceObjectManager extends Thread{
	...
	public SpaceObjectManager(Vector<SpaceObject> vObjs, Blackhole uBlackHole, ScorePanel uScorePanel, JPanel uPanel){
		this.vObjs = vObjs;
	...
	public void add(SpaceObject uObj){
		this.vObjs.add(uObj);
	}
	
	public static boolean collision(SpaceObject Obj1, SpaceObject Obj2){

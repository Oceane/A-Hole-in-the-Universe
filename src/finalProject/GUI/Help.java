...
public class Help extends JPanel {
	...
	private void window() {
		...
		objective.setText("The objective of the game is to get more points than the other players before the timer runs out.");
		objective.setEditable(false);

		// GAMEPLAY
		gameplayLabel = new JLabel("GAMEPLAY");
		gameplay = new JTextArea();
		gameplay.setText("Every player is a planet, which they will customize upon creation of a game session. " + "\nEach player plays the game independently of other players and is competing for the highest score. " + "\nThus, each player only sees their own player on the screen. " + "\nThe player controls the planet’s movement with arrow keys, and it  is in constant rotation, making movement challenging." + "\nA comet will bounce off the player according to the velocities and spins of the colliding objects. " + "\nPoints are earned by knocking comets into black holes. Every comet will be assigned a random starting point, point value, and velocity. " + "\nThe point values will be between 1,000 and 20,000 in increments of 1,000." + "\nThe point value of a comet will be displayed on top of the comet’s graphic. " + "\nPoints are lost when a player falls into a black hole. " + "\nPlayers can see other players’ scores as they go, encouraging competition. "
